...
## [Meet us]{.hidden} {background-image="assets/team.png" background-size="contain" footer=false}
...
::: text-center
![](../assets/positron-astropy.png){style="max-height: 90vh"}
:::
...
::: {.flex .flex-column .justify-center-ns .items-center-ns style="min-height: 40vh"}
...
## Your Turn {background-image="assets/your-turn.png" background-size="30%" background-position="bottom right"}

::: {style="--li-margin: 0.66em;"}
1. 🔓 Decrypt the `.env.secret` &rarr; `.env`:
    a. **R**: Run [secrets.R]{class="b--light-red red ph2 pv1 ba br2 code"}

    b. **Python:** Run [make secret-decrypt]{class="b--blue blue ph2 pv1 ba br2 code"} in terminal \
      or run [python secrets.py decrypt .env.secret > .env]{class="b--blue blue ph2 pv1 ba br2 code"}
