...
# [Programming is fun, but I kind of like ChatGPT...]{.bg-white .f1 .normal .relative style="top: -14px; left: 4px"} {background-image="assets/ask-anything.png" background-size="contain" background-position="center"}

# [ellmer and chatlas can do that, too!]{.bg-white .f1 .normal .relative style="top: -14px; left: 4px"} {background-image="assets/all-the-context.png" background-size="contain" background-position="center"}
...
# [shinychat]{.hidden} {.no-invert-dark-mode background-image="assets/shinychat-robot2.webp" background-size="cover" background-position="center"}
...
Add the Chat UI and server logic
