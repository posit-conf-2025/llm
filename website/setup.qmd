...
**You do not need to install ollama or use local models to participate in the workshop.**
...
For the workshop, I'd recommend installing `gemma3:4b`[^plus-more].

[^plus-more]: The best open-weights model you can run on a typical laptop (with 16GB of RAM and a decent processor, like an M1 Mac) is [gpt-oss:20b][ollama-gpt-oss]. For something a little bit smaller, try [qwen3:8b][ollama-qwen3-8b].
