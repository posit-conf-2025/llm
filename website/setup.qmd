...
* [Discord](https://discord.com/register)
  ...
  * Closer to the conference start, you'll be able to join the `{{< meta conference.name >}}` Discord server via the event portal at <https:://posi.it/conf-event-portal>.
...
<!-- TODO: Update as as recommended workflow -->
