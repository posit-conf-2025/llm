...
<!-- TODO: Add this back in if we figure out how to make pak work
...
Follow the instructions in `_setup.R` to deactivate renv and install the packages you need.

<details><summary>Backup setup code</summary>
